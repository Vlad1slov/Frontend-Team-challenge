        ...
        <>
            {window.innerWidth > 1280 ? (
                ...
                <div className={styles["header-mobile"]}>
                    <div className={styles["frame-26080104"]}>
                        <img src={mobileLogo} />
                        <div className={styles["account-and-cart"]}>
                            <div className={styles["frame-26080103"]}>
                                <svg
                                    className={styles["icons"]}
                                    width="24"
                                    height="24"
                            ...
                            <div className={styles["frame-26080100"]}>
                                <svg
                                    className={styles["icons2"]}
                                    width="24"
                                    height="24"
                            ...
                            <div className={styles["frame-26080101"]}>
                                <svg
                    ...
                    <div className={styles["frame-26080102"]}>
                        <div className={styles["input-chip"]}>
